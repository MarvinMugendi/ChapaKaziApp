...
public class EngineeringandScience extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engineeringand_science);
        ...
        //(SQL equivalent) SELECT * FROM Freelancer WHERE service = "Engineering and Science"
        Query query = FirebaseDatabase.getInstance().getReference("freelancer")
                .orderByChild("freelancerGenre")
                .equalTo("Engineering and Science");
